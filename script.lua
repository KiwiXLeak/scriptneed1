...
local function test(name, aliases)
	...
	task.spawn(function()
		if name == "getrawmetatabl1e" or name == "hookfuncti1on" or name == "fireclickdetect1or" or name == "setrawmetatabl1e" or name == "setrenderproperty" or name == "setfpscap" or name == "checkcaller" then
			fails += 1
			warn("⛔ " .. name)
